...
_start:
    ; On demande a l'utilisateur la chaine de caractere
    mov edx, 1           ; taille de la chaine => L'INPUT DOIT FAIRE OBLIGATOIREMENT 4 CARACTERES SINON LE PROGRAMME NE FONCTIONNE PAS
